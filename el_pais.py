...
for article in articles:
    ...
    if title_h2:
        ...
        href = title_a_tag['href'] if title_a_tag and 'href' in title_a_tag.attrs else None
    else:
        href = None
    ...
    if href:
        ...
        if body_div:
            body_content = body_div.find("div", class_="RichTextArticleBody RichTextBody")
            body_text = body_content.get_text(separator=" ", strip=True) if body_content else None
    else:
